#!/usr/bin/env bash
# nirc2pol_axiscal.sh — HWP (PCU rotator) movement with NIRC2 images, intended for fast axis finding/verification
# Written by R. Zhang, Sept 2025
# Edited by B. Lewis, Nov. 2025

# --------------------
# Defaults (override with key=value args)
OBJ="fast_axis_cal"          # object base name (quotes OK if spaces)
...
# TODO: Add calculation of how long it'll take to take all the exposures needed

# Silencing print statement for now
# echo "Running with:"
# echo "  FILT          = $FILT"
# echo "  OBJ           = $OBJ"
# echo "  ANGLES        = $ANGLES"
